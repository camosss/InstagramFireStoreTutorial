...
class FeedCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        profileImageView.setDimensions(height: 40, width: 40) // Dimension = 치수
...
//        print("DEBUG: did tap username")
        ...
        delegate?.cell(self, wantsToShowPrifileFor: viewModel.post.ownerUid)
    }
